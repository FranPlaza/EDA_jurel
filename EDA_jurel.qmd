---
title: "Análisis de datos exploratorios para proyecto jurel"
...
Con la información obtenida en la base de datos del crucero hidroacústico del 2020, se efectuó un análisis exploratorio de la información. La @fig-maps muestra el gráfico de la variable *Sa* con la *Temperatura.*
